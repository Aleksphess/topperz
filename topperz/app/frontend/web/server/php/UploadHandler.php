...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/user/'.$this->get_user_path(),
            'upload_url' => $this->get_full_url().'/files/user/'.$this->get_user_path(),
		...
		*/
                'thumbnail' => array(
                    ...
                    'max_width' => 126, // either specify width, or set to 0. Then width is automatically adjusted - keeping aspect ratio to a specified max_height.
                    'max_height' => 91 // either specify height, or set to 0. Then height is automatically adjusted - keeping aspect ratio to a specified max_width.
                )
            ),
            'print_response' => true
        );
    ...
    protected function get_user_id() {
       // @session_start();
        ...
        return $_COOKIE['lot_id'];
    }

    protected function get_user_path() {
        if ($this->options['user_dirs']) {
           // var_dump($this->get_user_id());die();
